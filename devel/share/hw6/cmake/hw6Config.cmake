...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hw6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/andi_ws/src/hw6/${idir}'.  Ask the maintainer 'Andi Frank <a2frank@eng.ucsd.edu>' to fix it.")
    endif()
